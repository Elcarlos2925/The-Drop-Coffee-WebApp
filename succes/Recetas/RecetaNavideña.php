...
<body>
    ...
    <div class="carrusel">
        ...
        <h2 class="titulo">Café Especial Navideño</h2>
        ...
        <div class="Receta">
            ...
            <br>
            <p><strong>Mezcla de especias</strong><br>
            <br>
            En lo que el café se prepara, en un recipiente pequeño, mezcla la canela, la nuez moscada y el clavo molido. Estas especias darán el toque navideño al café.</p>
            <br>
            <p><strong>Añadir las especias al café</strong><br>
            <br>
            Una vez que el café esté listo, agrega la mezcla de especias a la taza y mezcla bien para que se incorporen los sabores.</p>
            <br>
            <p><strong>Endulzar</strong><br>
            <br>
            Añade azúcar o edulcorante al gusto y revuelve para que se disuelva por completo.</p>
            <br>
            <p><strong>Decorar (opcional)</strong><br>
            <br>
            Si lo deseas, agrega un poco de crema batida en la parte superior del café para darle un toque festivo. Puedes espolvorear un poco de canela en polvo o colocar una ramita de canela como decoración.</p>
            <br>
            <p>Este café con especias navideñas tiene ese aroma y sabor característico de la temporada. Las especias añaden un toque cálido y reconfortante a tu taza de café, ¡perfecto para disfrutar durante las festividades!</p>
            </div>
            </br>
            <hr>
        </div>
